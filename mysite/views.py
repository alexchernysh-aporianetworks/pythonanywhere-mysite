...
def run_Yoav_creatives_builder_script(request):
    script_path = "/home/Karmel/Aporia_Networks/workflows/creative_builder_dev/creatives_builder_Yoav.py"
    return execute_script(request, script_path)
...
def run_Or_creatives_builder_script(request):
    script_path = "/home/Karmel/Aporia_Networks/workflows/creative_builder_dev/creatives_builder_Or.py"
    return execute_script(request, script_path)
